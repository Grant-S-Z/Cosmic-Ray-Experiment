...
\maketitle
\begin{frame}[label={sec:orgc8b829d}]{目录}
\tableofcontents
\end{frame}
\section{实验目标}
\label{sec:orgecfc580}
\begin{frame}[label={sec:org3fb5f92}]{实验目标}
\begin{enumerate}
...
\end{frame}
\section{实验装置}
\label{sec:org7a010b4}
\begin{frame}[label={sec:org1e458bd}]{实验装置}
\begin{figure}[htbp]
\centering
...
\end{frame}
\section{实验结果}
\label{sec:org78c204c}
\begin{frame}[label={sec:orgf820682}]{\(\mu\) 信号测量}
...
\begin{frame}[label={sec:org4b1a9ae}]{\(\mu\) 信号测量}
