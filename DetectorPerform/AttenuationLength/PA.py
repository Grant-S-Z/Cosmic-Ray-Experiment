...
[logq,logqe,delta_t,delta_te] = [rt.std.vector('double')(),rt.std.vector('double')(),rt.std.vector('double')(),rt.std.vector('double')()]
dt=1e-9
...
for i in range(41):
    ...
    # print(q1,q2,N)
    dloge=np.sqrt(2*SphotonCharge**2*N*p1*(1-p1)/q1**2+2*SphotonCharge**2*N*p1*(1-p1)/q2**2)
